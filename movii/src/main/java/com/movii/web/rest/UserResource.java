...
import com.movii.config.Constants;
import com.movii.domain.User;
import com.movii.repository.UserRepository;
import com.movii.security.AuthoritiesConstants;
import com.movii.service.MailService;
...
import com.movii.web.rest.errors.EmailAlreadyUsedException;
import com.movii.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.movii.domain.User} entity, and needs to
...
public class UserResource {
    ...
    public Mono<AdminUserDTO> getUser(@PathVariable("login") String login) {
        ...
        if (StringUtils.isNumeric(login)) {
            return userRepository
                    .findOneById(Long.parseLong(login))
