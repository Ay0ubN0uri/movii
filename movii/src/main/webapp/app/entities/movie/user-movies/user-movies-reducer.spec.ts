...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMOVIES_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERMOVIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERMOVIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERMOVIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERMOVIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERMOVIES actions', async () => {
      const expectedActions = [
        {
