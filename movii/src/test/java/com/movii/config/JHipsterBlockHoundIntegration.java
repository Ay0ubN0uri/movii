...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.movii.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.movii.security.DomainUserDetailsService", "createSpringSecurityUser");
