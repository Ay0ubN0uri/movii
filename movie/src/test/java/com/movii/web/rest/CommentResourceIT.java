...
class CommentResourceIT {
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).rating(UPDATED_RATING).createdDate(UPDATED_CREATED_DATE).userId(UPDATED_USER_ID);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.rating(UPDATED_RATING).createdDate(UPDATED_CREATED_DATE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).rating(UPDATED_RATING).createdDate(UPDATED_CREATED_DATE).userId(UPDATED_USER_ID);
