...
import com.movii.service.CommentService;
import com.movii.service.UserService;
...
/**
 * REST controller for managing {@link com.movii.domain.Comment}.
 */
@RestController
...
public class CommentResource {
    ...
    private static final String ENTITY_NAME = "movieComment";
    ...
    public CommentResource(CommentService commentService, CommentRepository commentRepository,
            UserFeignClient userFeignClient, UserService userService) {
    ...
    @GetMapping("/a00n")
    public List<CommentDTO> getMethodName() {
        System.out.println(userFeignClient.userId("11"));
        return null;
    }
    ...
    public ResponseEntity<CommentDTO> createComment(@RequestBody CommentDTO commentDTO) throws URISyntaxException {
        ...
        commentDTO = commentService.addUser(commentDTO);
        if (commentDTO.getUser() == null) {
            throw new BadRequestAlertException("The user not found", ENTITY_NAME,
                    "idnotfound");
        }
    ...
    public ResponseEntity<CommentDTO> updateComment(
        ...
        commentDTO = commentService.addUser(commentDTO);
        if (commentDTO.getUser() == null) {
            throw new BadRequestAlertException("The user not found", ENTITY_NAME, "idnotfound");
        }
